...
<?php
   ...
   //select the last transaction id in the sender's passbook
    ...
    elseif($s_total<500)
    {
        ...
        $sql1="insert into passbook".$reciever_id." values(default,'$date','$r_name','$r_branch','$r_ifsc','$t_amount','0','$r_total','BY $s_name')";
        mysqli_query($con, $sql1) or die(mysqli_error($con));

        //insert statement into sender passbook.
        $s_total=$s_amount-$t_amount;
        $sql2="insert into passbook".$sender_id." values(default,'$date','$s_name','$s_branch','$s_ifsc','0','$t_amount','$s_total','TO $r_name')";
